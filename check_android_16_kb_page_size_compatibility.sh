...
# Use this script by providing the path to your APK, APEX, or directory of native libraries
# Example: ./check_android_16_kb_page_size_compatibility.sh build/app/outputs/flutter-apk/app-flavor_pre_test-release.apk
